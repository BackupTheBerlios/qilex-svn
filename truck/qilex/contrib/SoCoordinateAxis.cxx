...
void SoCoordinateAxis::updateChildren() {
  ...
  myXTransform->rotation.setValue(SbVec3f(0,0,1),-(float)M_PI_2);
  ...
  myZTransform->rotation.setValue(SbVec3f(1,0,0),(float)M_PI_2);
...
void SoCoordinateAxis::makeDivision(SoSeparator* divs){
  ...
  subRotX->rotation.setValue(SbVec3f(0,0,1),-(float)M_PI_2);
  ...
  subRotZ->rotation.setValue(SbVec3f(1,0,0),(float)M_PI_2);
...
void SoCoordinateAxis::generateAlternateRep() {
