 ...
 */
panel_control::panel_control( QWidget* parent,  const char* name, Rchain *pkinechain)
    : QWidget( parent, name)
{
   if ( !name )
...
void panel_control::slotmove_home()
{
   kinechain->do_ready();
}
void panel_control::update_limits()
{
   double min, max;
   for(int i=0; i<kinechain->dof;i++)
   {
...
bool panel_control::close(bool autoDelete)
{
  //hide(); //cal posar quelcom
  return FALSE;
}

void panel_control::slot_buttonXinc()
{
   emit newValueX(microinterval);
}
void panel_control::slot_buttonYinc()
{
   emit newValueY(microinterval);
}
void panel_control::slot_buttonZinc()
{
   emit newValueZ(microinterval);
}
void panel_control::slot_buttonRXinc()
{
   emit newValueRX(microangle);
}
void panel_control::slot_buttonRYinc()
{
   emit newValueRY(microangle);
}
void panel_control::slot_buttonRZinc()
{
...
void panel_control::slot_buttonXdec()
{
   emit newValueX(-microinterval);
}
void panel_control::slot_buttonYdec()
{
   emit newValueY(-microinterval);
}
void panel_control::slot_buttonZdec()
{
   emit newValueZ(-microinterval);
}
void panel_control::slot_buttonRXdec()
{
   emit newValueRX(-microangle);
}
void panel_control::slot_buttonRYdec()
{
   emit newValueRY(-microangle);
}
void panel_control::slot_buttonRZdec()
{
   emit newValueRZ(-microangle);
}

void panel_control::slot_setworld()
{
...
void panel_control::slot_settool()
{
...
void panel_control::slot_updatetext(QString &line)
{
   TextBrowser->insertLineAtEnd(line);
}
void panel_control::move_pickpoint(Rhmatrix point)
{
