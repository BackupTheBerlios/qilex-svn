...
class SoQtComposeRotation : public QObject, public SoEngine{
   Q_OBJECT

   SO_ENGINE_HEADER(SoQtComposeRotation);
   
   public: 


   //Input fields
      SoSFFloat angle; //in rads

      SoSFVec3f axis;

      SoEngineOutput rotation; //SoRotation
